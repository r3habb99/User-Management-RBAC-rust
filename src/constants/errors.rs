...
pub const ERR_CANNOT_DEMOTE_SELF: &str = "Administrators cannot demote themselves. Ask another admin to do this.";
pub const ERR_NO_PERMISSION_UPDATE_PROFILE: &str = "You don't have permission to update this user's profile";
pub const ERR_NO_PERMISSION_DELETE_ACCOUNT: &str = "You don't have permission to delete this user's account";
pub const ERR_NO_PERMISSION_AVATAR_UPLOAD: &str = "You don't have permission to upload avatar for this user";
pub const ERR_NO_PERMISSION_AVATAR_DELETE: &str = "You don't have permission to delete avatar for this user";
pub const ERR_CHANGE_OWN_PASSWORD_ONLY: &str = "You can only change your own password. For other users, use the password reset feature.";
...
pub const ERR_INVALID_FILE_TYPE: &str = "Invalid file type. Only JPEG, PNG, GIF, and WebP are allowed.";
pub const ERR_FILE_TOO_LARGE: &str = "File too large. Maximum size is 5MB.";
pub const ERR_NO_AVATAR_FILE: &str = "No avatar file provided. Please upload a file with field name 'avatar'.";
